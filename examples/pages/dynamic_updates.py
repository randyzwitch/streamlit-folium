...
def main():
    ...
    wkt2 = "POLYGON ((-122.397416 37.795017, -122.397137 37.794712, -122.396332 37.794983, -122.396171 37.795483, -122.396858 37.795695, -122.397652 37.795466, -122.397759 37.79511, -122.397416 37.795017))"
    ...
    style_parcels = {'fillColor': '#1100f8', 'color': '#1100f8', 'fillOpacity': 0.13, 'weight': 2 }
    style_buildings = {'color': '#ff3939', 'fillOpacity': 0, 'weight': 3, 'opacity': 1, 'dashArray': '5, 5'}
